...
@section('user_content')
    <div class="d-flex align-items-center px-6 py-5">
        <div class="text-light mr-auto">
            <h2 class="fw-100 mb-0"> Bkash Product Withdraw Request</h2>
            <span class="lead-1 text-info"> Bkash Product Withdraw Request</span>
        </div>
    </div>
    <!-- Transparent -->
        ...
        <div class="position-relative my-2">
            <form class="input-transparent" action="{{ route('cashout.product.request.store') }}" method="POST"
                ...
                <div class="mt-0 mb-3">
                    ...
                    <div>
                        <code class="p-5">Bkash Product Withdraw</code>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="input-group">
                            <input type="number" name="number" class="form-control" id="bkash"
                                placeholder="Enter bkash number" min="0" required>
                        </div>
                        @error('number')
