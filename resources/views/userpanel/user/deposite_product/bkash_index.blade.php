...
<div class="d-flex align-items-center px-6 py-5">
	<div class="text-light mr-auto">
	    <h2 class="fw-100 mb-0">BKASH Deposite Request</h2>
	    <span class="lead-1 text-info">BKASH Deposite Request</span>
	</div>
</div>
<!-- Transparent -->
<div class="mt-0 mb-5 m-5" style="background-image: url({{asset('frontend/assets/img/bg/bg-2.jpg')}});" data-overlay="9">
	<div class="position-relative my-2">
	  <form class="input-transparent" action="{{ route('deposite.request.store') }}" method="POST" enctype="multipart/form-data">
	  	@csrf
	    <div class="mt-0 mb-3">
	     
	      <div>
	        <code class="p-5">BKASH Request</code>
	      </div>
	    </div>
	    <div class="col-12">
	    ...
	    <div class="mt-5">
	      ...
	      <div class="input-group">
	        ...
	        <input type="text" value="{{ $configData->bkash_wallet }}" readonly name="wallet_address" class="form-control" id="copyWallet">
	      </div>
	    </div>
