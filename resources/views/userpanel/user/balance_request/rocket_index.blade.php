...
<div class="d-flex align-items-center px-6 py-5">
	<div class="text-light mr-auto">
	    <h2 class="fw-100 mb-0">Rocket Balance Request</h2>
	    <span class="lead-1 text-info">Rocket Balance Request</span>
	</div>
</div>
<!-- Transparent -->
	...
	<div class="position-relative my-2">
	  <form class="input-transparent" action="{{ route('balance.request.store') }}" method="POST" enctype="multipart/form-data">
	    ...
	    <div class="mt-0 mb-3">
	      ...
	      <div>
	        <code class="p-5">Rocket Request</code>
	      </div>
	    </div>
	    <div class="col-12">
	    ...
	    <div class="mt-5">
	      ...
	      <div class="input-group">
	        ...
	        <input type="text" value="{{ $configData->rocket_wallet }}" readonly name="wallet_address" class="form-control" id="copyWallet">
	      </div>
	    </div>
