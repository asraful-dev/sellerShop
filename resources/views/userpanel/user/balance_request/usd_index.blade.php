...
<div class="d-flex align-items-center px-6 py-5">
	<div class="text-light mr-auto">
	    <h2 class="fw-100 mb-0">USD Balance Request</h2>
	    <span class="lead-1 text-info">USD Balance Requst</span>
	</div>
</div>
<!-- Transparent -->
	...
	<div class="position-relative my-2">
	  <form class="input-transparent" action="{{ route('balance.request.store') }}" method="POST" enctype="multipart/form-data">
	    ...
	    <div class="mt-0 mb-3">
	      ...
	      <div>
	        <code class="p-5">USD Request</code>
	      </div>
	    </div>
	    <div class="col-12">
       		<input type="hidden" value="USD" name="gateway" />
       		<div align="center">
         	<img style='height:40px;width:70px;border-radius: 15px; margin-top: 20px;' src="{{ asset('upload/amount') }}/usd.png" alt="Usd">
         </div>
	    <div class="mt-5">
	    	<label>Sender USDT/TRC20 Address</label>
