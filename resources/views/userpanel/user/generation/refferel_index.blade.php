		      ...
		      <div class="col">
		         <div class="py-7">
		            ...
		            <div class="px-4 px-md-6">
                           ...
                           <!--         $refferel_users = App\Models\User::where('refer_by', $current_user)->get();-->
                           <!--     @endphp-->
		                        ...
		                        <tbody>
		                            ...
		                            <tr>
		                                ...
		                                <td>
		                                 ...
		                                 <td>
											<a href="{{ route('user.refferel.list') }}?id={{ $refferel_user->id }}" class="btn btn-success btn-sm">{{ $refferel_user->username }}</a>
		                                </td> 
