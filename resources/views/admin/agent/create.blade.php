...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Create Agent</div>
            <div class="ps-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                              ...
                              <div class="col-12 mt-1">
                                ...
                                <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                  <input type="text" name="username" value="{{ old('username') }}" class="form-control border-start-0" id="username" placeholder="Enter username" required />
                                </div>
                                @error('username')
                                  <span class="text-danger">{{ $message }}</span>
                                @enderror
                              ...
                              <div class="col-12 mt-1">
                               ...
                               <div class="col-12 mt-1">
                                ...
                                <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                  <input type="text" name="refer_by" value="{{ old('refer_by') }}" class="form-control border-start-0" id="refer_by" placeholder="Enter Refer By" />
                                </div>
                                @error('refer_by')
                                  <span class="text-danger">{{ $message }}</span>
                                @enderror
