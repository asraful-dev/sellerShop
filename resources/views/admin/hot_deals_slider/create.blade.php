...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('hot_deals_slider.index') }}" class="btn btn-primary">Slider List</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
      ...
      <div class="container-fluid">
        <!-- Page Heading -->
         <!-- DataTales Example -->
         <div class="row">
            <form method="post" action="{{ route('hot_deals_slider.store') }}" enctype="multipart/form-data">
              @csrf
                        ...
                        <div class="row">
                          <div class="col-md-12 mt-3">
                              <div class="form-group">
                                <label for="slider_img">Slider Image <span class="text-light font-weaight-bolder">(Size:1620,425):</span></label>
