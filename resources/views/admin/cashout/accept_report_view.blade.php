...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Accepted Requests</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Accepted Requests</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <!--end breadcrumb-->
        <span class="badge badge-success rounded-pill" style="font-size: 18px;"> AcceptList Count ({{ count($acceptLists) }}) </span>
        <hr/>
        <div class="card">
            <div class="card-body">
                    ...
                    <table id="example" class="table table-striped table-bordered table-responsive-sm" style="width:100%">
                        ...
                        <tbody>
                            @php
                                $i = 1;
                            @endphp
                            @foreach($acceptLists as $cashoutrequest)
                                <tr>
                                    <td>
                                        {{ $i++ }}
                                    </td>
