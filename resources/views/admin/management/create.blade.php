    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Management Create</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Management Create</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    ...
                    <form method="post" action="{{ route('management.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-10 offset-1">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <h4>Management Create</h4>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="form-label" for="position" name="position" id="position"
                                                    required="">Select Position</label>
                                                <select class="single-select form-control form-select" name="position"
                                                    required>
                                                    <option value="" selected disabled>Select Position</option>
                                                    <option value="1">Managment Member</option>
                                                    <option value="2">Royal Member</option>
                                                    <option value="3">Founder Member</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <div class="input-group input-group-lg"> <span class="input-group-text"><i
                                                        class='bx bxs-user'></i></span>
                                                <input type="text" name="experience" class="form-control border-start-0"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="file" class="form-control category_image"
                                                        name="photo" id="category_image" required>
