                     ...
                     <li class="nav-item dropdown dropdown-large">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                           ...
                           <div class="header-notifications-list">
                              ...
                              @elseif($notification->type == 'App\Notifications\ProductStockNotification')
                              <a class="dropdown-item" href="javascript:;">
                                 <div class="d-flex align-items-center">
                                    <div class="notify"><i class="bx bx-cart-alt"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                       <h6 class="msg-name">New Stock Deposite
                                          {{-- <span class="msg-time float-end">
                                             {{ date("F j Y, g:i a", strtotime($notification->created_at)) }} ago
                                          </span> --}}
                                       </h6>
                                       <p class="msg-info">Amount: {{$notification->data['amount']}}</p>
                                    </div>
                                 </div>
                              </a>
                              @endif
