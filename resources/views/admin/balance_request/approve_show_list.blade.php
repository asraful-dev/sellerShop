...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Approved Requests</div>
            <div class="ps-3">
        ...
        <!--end breadcrumb-->
        <span class="badge badge-success rounded-pill" style="font-size: 18px;"> Approved Requests Count ({{ count($approved_reports) }}) </span>
        <hr/>
        <div class="card">
            <div class="card-body">
