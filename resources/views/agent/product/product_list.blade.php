...
@section('agent')
    ...
    <div class="page-content">
        <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="product-price">
                                            <span
                                                class="price text-primary old-price">৳{{ $product->wholesell_price }}</span>
                                        </div>

                                        <p class="mb-0 fw-bold">Stock Qty<strong class="text-primary">
                                                {{ $product->stock_qty }}</strong></p>
            ...
            <div class="col-sm-4">
                <form action="{{ route('agent.pos.store') }}" method="POST">
                    @csrf
                    <div class="card mb-4">
                        <div class="card-body">
