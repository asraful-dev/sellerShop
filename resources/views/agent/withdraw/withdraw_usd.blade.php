    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-12 mx-auto">
               <h6 class="mb-0 text-uppercase">Bank Withdraw Request</h6>
               <hr>
                  ...
                  <div class="card-body">
                     <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                           ...
                           <h5 class="mb-0 text-info">Bank Withdraw Request</h5>
                        </div>
                        <hr>
                    ...
                    @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                             <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                             <input type="number" id="discount" name="withdraw_charge" class="form-control" value="10" placeholder="Discount" min="0" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
