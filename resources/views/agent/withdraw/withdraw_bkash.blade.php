        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Bkash Withdraw Request</h6>
                    <hr>
                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-info">Bkash Withdraw Request</h5>
                                </div>
                                <hr>
                                <form class="input-transparent" action="{{ route('agent.withdraw.request.store') }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Bkash Number</label>
                                        <div class="col-sm-9">
