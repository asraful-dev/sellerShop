...
class AdminController extends Controller
{
    ...
    /*=============== Start Admin Role User/Staff/Account Method ================ */

    public function AllAdmin(){
        // $alladminuser = User::where('role','admin')->latest()->get();
        $alladminuser = User::latest()->get();
        return view('admin.admin_setting.all_admin',compact('alladminuser'));
    }// End Mehtod
    ...
    public function EditAdminRole($id){
        ...
        $roles = Role::all();
        return view('admin.admin_setting.edit_admin',compact('adminuser','roles'));
    }// End Mehtod
    ...
    /*=============== End Admin Role User/Staff/Account Method ================ */
